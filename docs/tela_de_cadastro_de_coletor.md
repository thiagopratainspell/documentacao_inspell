# <span class="titulo_azul"> <b>Tela de Cadastro de Coletores</b> </span>

A tela de cadastro é acessada ao clicar em **<span style="color: white; background-color: rgb(2, 85, 197); border-radius: 5px; padding: 5px">+ Novo Coletor</span>** ou no **ícone de edição** de um coletor existente. O formulário é organizado nas seguintes **seções expansíveis**, que permitem realizar **diversas confugrações**:
